...
require("master.php");
$connectingdb; $to=0;
$sql_customer="SELECT COUNT(*) FROM customer";
$stmt=$connectingdb->query($sql_customer);
$count=$stmt->fetch();
$total_customer=array_shift($count);

$sql_sale="SELECT SUM(amount) FROM paynow";
$stmt=$connectingdb->query($sql_sale);
$count=$stmt->fetch();
$total_sale=array_shift($count);
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- Mirrored from demo.geekslabs.com/materialize/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jul 2015 06:55:33 GMT -->
<head>
...
<body>
            ...
            <!-- START CONTENT -->
            <section id="content" style="width: 80%;margin-left:20%">
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content  green white-text">
                                        ...
                                        <h4 class="card-stats-number"><?php echo $total_customer; ?></h4>
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content purple white-text">
                                        ...
                                        <h4 class="card-stats-number">$<?php echo $total_sale; ?></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    ...
                                    <div class="card-content">
                                        <img src="images/avatar2.jpg" alt="" class="circle responsive-img activator card-profile-image">
                        ...
                        <li>
                            ...
                            <div class="collapsible-body favorite-associates">
                                <div class="favorite-associate-list chat-out-list row">
                                    <div class="col s4"><img src="images/avatar2.jpg" alt="" class="circle responsive-img online-user valign profile-image">
                                    </div>
                                    <div class="col s8">
                                        <p>Eileen Sideways</p>
                                ...
                                <div class="favorite-associate-list chat-out-list row">
                                    <div class="col s4"><img src="images/avatar2.jpg" alt="" class="circle responsive-img offline-user valign profile-image">
                                    </div>
                                    <div class="col s8">
                                        <p>Renov Leongal</p>
    ...
    <!-- START FOOTER -->
    <footer class="page-footer" style="margin-bottom: 55px;">
        <div class="container">
            <div class="row">
